            ...
            <nav className='flex flex-row items-center justify-between mx-3 ' >
              ...
              <div className=" ">
                 <from className="Form flex flex-row items-center justify-end h-11 w-auto border-none">
                   <input type="search" id="search" name="search" placeholder='Search' className='w-6xl h-11  border px-2'/>
                    
                    <button type="button " className='flex flex-row items-center justify-center w-16 h-11  border bg-gray-50' ><AiOutlineSearch className=' h-6 w-7'/></button>
              ...
              <div className='apps flex flex-row items-center justify-between mx-2'>
                  ...
                  <div className='flex flex-row items-center justify-center border px-1.5 text-blue-500 border-blue-500 rounded'>
